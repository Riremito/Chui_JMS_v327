...
//                int ad = Integer.parseInt(lol);
            ...
            case "magnus_summon": {
                ...
                for (int i = 0; i < 30; i++) {
                    c.getPlayer().getMap().spawnObtacle();
                }
                break;
            }
...
//                        unequip(c, 1542044, true);
    ...
    private static void sendDojoStart(MapleClient c, int stage) {
        ...
        c.announce(CField.environmentChange("dojang/start/stage", 12/*13*/));//was3
        c.announce(CField.environmentChange("dojang/start/number/" + stage, 12/*13*/));//was3
