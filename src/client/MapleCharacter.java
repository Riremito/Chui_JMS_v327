...
public class MapleCharacter extends AnimatedMapleMapObject implements Serializable, MapleCharacterLook {
    ...
    private int accountid, id, hair, face, secondHair, secondFace, faceMarking, ears, tail, mapid, fame, pvpExp, pvpPoints,
            ...
            remainingAp, honourExp, honorLevel, runningLight, runningLightSlot, LightWing, runningDark, runningDarkSlot, DarkWing, luminousState, touchedrune, weaponPoint;
...
//                map.broadcastMessage(this, CField.showForeignDamageSkin(this, getDamageSkin()), true);
...
//            client.announce(CField.showForeignDamageSkin(this, getDamageSkin()));
...
//        client.announce(EffectPacket.TutInstructionalBalloon("Effect/OnUserEff.img/RecordClear_BT/clear"));
    ...
    public void setLuminousMode(final int skillid) {
        ...
        if (/*skillid >= 27100000 && skillid < 27120400 */chage_skill == 20040216 || chage_skill == 20040217 && (luminousState != 20040219 && luminousState != 20040220)) {
...
/*            if ((getLightGauge() <= 0 && runningLight == 1) || (getDarkGauge() >= 9999) && runningDark == 1) {
                ...
                client.announce(CWvsContext.enableActions());
            } else */if (chage_skill == 20040216 || chage_skill == 20040217/* &&skillid >= 27100000 && skillid < 27120400 && getLuminousState() < 20040000*/) {
    ...
    public void changeLuminousMode(final int skillid) {
        ...
        WorldTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                MapleStatEffect effect1 = SkillFactory.getSkill(luminousState).getEffect(getTotalSkillLevel(luminousState));
                EnumMap stat1 = new EnumMap(MapleBuffStat.class);
                stat1.put(MapleBuffStat.LUMINOUS_GAUGE, 1);
                client.announce(CWvsContext.BuffPacket.giveBuff(luminousState, 0, stat1, effect1, chr));
                effect1.applyTo(chr);
            }
        }, 20000);
    }
...
/*        if (runningLightSlot == 0 && runningDarkSlot == 0) {
        ...
        if (runningDark == 0 && runningLight == 0) {
        ...
        if (runningLight == 1) {
            for (int light : lightSkills) {
                if (skillid == light) {
                    ...
                    if (runningLightSlot > 9999) {
                        LightWing += 1;
                        runningLightSlot = 0;
                    }
                    if (LightWing > 5) {
                        setLuminousMode(20040219);
                        LightWing -= 1;
                    }
/*                    runningLightSlot -= 277;
...
//                    type = 1;
        ...
        if (runningDark == 1) {
            for (int dark : darkSkills) {
                if (skillid == dark) {
                    runningDarkSlot += 277;
                    if (runningDarkSlot > 9999) {
                        DarkWing += 1;
                        runningDarkSlot = 0;
                    }
                    if (DarkWing > 5) {
                        changeLuminousMode(20040220);
                        DarkWing -= 1;
                    }
...
//                    type = 2;
        ...
        client.announce(LuminousPacket.updateLuminousGauge(this));
//        client.announce(LuminousPacket.updateLuminousGauge(runningSolt, type));
    ...
    public int getDarkWing() {
        return DarkWing;
    }

    public void setDarkWing(int dw) {
        this.DarkWing = dw;
    }
    ...
    public int getLightWing() {
        return LightWing;
    }

    public void setLightWing(int lw) {
        this.LightWing = lw;
    }
