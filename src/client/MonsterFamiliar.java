...
public final class MonsterFamiliar extends AnimatedMapleMapObject
    ...
    public void addFatigue(MapleCharacter owner, int f) {
        ...
        owner.getClient().announce(CField.updateFamiliar(this));
    ...
    public void sendSpawnData(MapleClient client) {
        client.announce(CField.spawnFamiliar(this, true, false));
    }

    @Override
    public void sendDestroyData(MapleClient client) {
        client.announce(CField.spawnFamiliar(this, false, false));
    }
    ...
    public void writeRegisterPacket(MaplePacketLittleEndianWriter mplew, boolean chr) {
        ...
        mplew.writeAsciiString("", 13); // familar name
        mplew.write(chr ? 1 : 0);
...
//        mplew.writeLong(PacketHelper.getTime(System.currentTimeMillis()));
        ...
        mplew.write(0);
        mplew.write(0);
        mplew.writeShort(0/*getVitality()*/);
        mplew.writeShort(0);
        mplew.writeShort(0);
    }
}
