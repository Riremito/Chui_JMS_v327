...
public class MapleItemInformationProvider {
    ...
    protected final Map<Integer, Integer/*ArrayList<Integer>*/> tempOption = new TreeMap<>((v1, v2) -> v1.compareTo(v2));
    ...
    public int/*ArrayList<Integer>*/ getTempOption(int itemId) {
        int soulName = itemId % 1000 + 1;
        if (!tempOption.containsKey(soulName)) {
            MapleData skillOptionData = itemData.getData("SkillOption.img");
            int pots = MapleDataTool.getIntConvert("skill/" + soulName + "/tempOption", skillOptionData, 0);
