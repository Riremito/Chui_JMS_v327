    ...
    public void handleBuff(MapleStatEffect eff, int skill) {
        switch (skill) {
            ...
            case 32121056: //戰鬥精通
                ...
                break;
            case 32111012: // 藍色繩索
                eff.statups.put(MapleBuffStat.AURA, (int) eff.getLevel());
                eff.statups.put(MapleBuffStat.BLUE_AURA_OLD, eff.getX());
/*                eff.statups.put(MapleBuffStat.NEW_AURA, (int) eff.getLevel());
            ...
            case 32121017: // 黑色光環
                eff.statups.put(MapleBuffStat.AURA, (int) eff.getLevel());
                eff.statups.put(MapleBuffStat.DARK_AURA_OLD, eff.getX());
/*                eff.statups.put(MapleBuffStat.INDIE_DAM_R, eff.info.get(MapleStatInfo.indieDamR));
                eff.statups.put(MapleBuffStat.NEW_AURA, (int) eff.getLevel());*/
                eff.info.put(MapleStatInfo.time, 2100000000);
                break;
            ...
            case 32001016: // 黃色光環
                eff.statups.put(MapleBuffStat.AURA, (int) eff.getLevel());
                eff.statups.put(MapleBuffStat.YELLOW_AURA_OLD, eff.getX());
/*                eff.statups.put(MapleBuffStat.NEW_AURA, (int) eff.getLevel());
