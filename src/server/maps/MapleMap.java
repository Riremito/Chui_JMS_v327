...
/*        if (!instanced && mapobjects.get(MapleMapObjectType.ITEM).size() >= 255) {
    ...
    public final void spawnObtacle() {
        ...
        loa.add(oa);
        broadcastMessage(CField.spawnObtacleBomb(loa));
    }
...
//            broadcastMessage(chr, CField.showForeignDamageSkin(chr, chr.getDamageSkin()), true);
