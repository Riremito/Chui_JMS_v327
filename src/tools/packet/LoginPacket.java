...
public class LoginPacket {
    ...
    public static byte[] getHello(byte[] sendIv, byte[] recvIv) {
        ...
        mplew.writeShort(16); // 數據長度(不包含這裡)
    ...
    public static byte[] getLoginBackground() {
        ...
        String[] bg = {/*"MapLogin", "MapLogin0", "MapLogin1", "MapLogin2"*/"MapLogin2"};
...
//        mplew.write(HexTool.getByteArrayFromHexString("01 00 01 01 01 01 01 01 01 01 01 01 01 01 01 01 01 01 01 01 00 01 01 00 01 01 01 01 01 01 01 01 01 01 01 01 01 00 00 00"));
...
//            mplew.write(unk);
    ...
    public static byte[] getServerList(WorldConstants.Option world) {
        ...
        mplew.writeInt(0x0E); // 這邊是0的話將不能創角色
...
//        mplew.write(0);
    ...
    public static byte[] getTest() {
        ...
        mplew.writeShort(SendPacketOpcode.TEST.getValue());
        mplew.write(1);
        mplew.write(1);
        mplew.writeZeroBytes(500);
