...
//        mplew.writeShort(0);//176+
    ...
    public static byte[] charInfo(MapleCharacter chr, boolean isSelf) {
        ...
        mplew.write(250/*chr.getLevel()*/); // 等級上限
...
//    }
    ...
    public static class BuddylistPacket {
        ...
        public static byte[] updateBuddylist(Collection<BuddylistEntry> buddylist) {
            return updateBuddylist(buddylist, 0x177);
        }
...
//        mplew.writeZeroBytes(6);
    ...
    public static class PartyPacket {
        ...
        public static byte[] partyCreated(MapleParty party) { // 建立隊伍
            ...
            mplew.writeShort(0);
            mplew.write(0);
            mplew.write(0/*party.isPrivate() ? 0 : 1*/);
        ...
        public static byte[] giveBuff(int buffid, int bufflength, Map<MapleBuffStat, Integer> statups, MapleStatEffect effect, MapleCharacter chr) {
            ...
            for (Map.Entry<MapleBuffStat, Integer> stat : statups.entrySet()) {
                if (!stat.getKey().canStack() && stat.getKey() != MapleBuffStat.DEFAULTBUFF1) {
                    ...
                    mplew.writeInt(buffid == 35120000 ? 35001002 : buffid);
...
/*            if (statups.containsKey(MapleBuffStat.IDA_BUFF_461)) {
            ...
            mplew.writeZeroBytes(100); // 防止長度不夠38
...
//                mplew.writeInt(0);
            ...
            if (statups.containsKey(MapleBuffStat.IDK_UNK_357)) {
                mplew.writeInt(0);
            }
            ...
            if (statups.containsKey(MapleBuffStat.LUMINOUS_GAUGE)) {
                ...
                mplew.writeInt(chr.getDarkWing());
                mplew.writeInt(chr.getLightWing());
                mplew.writeInt(ct);//283183599 (according to old packet)
            }
            ...
            if (statups.containsKey(MapleBuffStat.QUIVER_KARTRIGE)) {
                mplew.writeInt(chr.getBuffedValue(MapleBuffStat.QUIVER_KARTRIGE));
            }
