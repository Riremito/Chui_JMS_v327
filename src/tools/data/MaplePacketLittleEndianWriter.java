...
public class MaplePacketLittleEndianWriter {
    ...
    public final void writeInt(final boolean b) {
        baosWrite((byte) ((b ? 1 : 0) & 0xFF));
        baosWrite((byte) (((b ? 1 : 0) >>> 8) & 0xFF));
        baosWrite((byte) (((b ? 1 : 0) >>> 16) & 0xFF));
        baosWrite((byte) (((b ? 1 : 0) >>> 24) & 0xFF));
        log("\r\n");
    }
    /**
