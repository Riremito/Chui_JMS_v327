...
//        米哈逸(9, MapleJob.米哈逸.getId(), 913070000, JobInfoFlag.褲裙.getVelue()),//TODO 出生劇情修正
        夜光(9/*10*/, MapleJob.夜光.getId(), 101000000, JobInfoFlag.披風.getVelue()),//TODO 出生劇情Ellinia atm
        凱撒(10/*11*/, MapleJob.凱撒.getId(), 940001000/*400000000*/),//TODO 出生劇情
        天使破壞者(11/*12*/, MapleJob.天使破壞者.getId(), 940011000),//TODO 出生劇情400000000 - 940011000 - town now
        重砲指揮官(12/*13*/, MapleJob.初心者.getId(), 0),//TODO 出生劇情
        傑諾(13/*14*/, MapleJob.傑諾.getId(), 931050920, JobInfoFlag.臉飾.getVelue()),//TODO 出生劇情
        神之子(16/*15*/, MapleJob.神之子.getId(), 100000000, JobInfoFlag.披風.getVelue() | JobInfoFlag.副手.getVelue()),//TODO 出生劇情321000000 = zero starter map
...
//        蒼龍俠客(19, MapleJob.初心者.getId(), 552000050, JobInfoFlag.褲裙.getVelue()),//TODO 出生劇情End map for tutorial
        劍豪(14/*20*/, MapleJob.劍豪.getId(), 807100010, JobInfoFlag.帽子.getVelue() | JobInfoFlag.手套.getVelue()),
        陰陽師(15/*21*/, MapleJob.陰陽師.getId(), 807100110, JobInfoFlag.帽子.getVelue() | JobInfoFlag.手套.getVelue()),
        幻獸師(17/*22*/, MapleJob.幻獸師.getId(), 866100000, JobInfoFlag.臉飾.getVelue() | JobInfoFlag.耳朵.getVelue() | JobInfoFlag.尾巴.getVelue());//TODO 出生劇情
