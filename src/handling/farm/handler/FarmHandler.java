...
public class FarmHandler {
    ...
    public static void createFarm(LittleEndianAccessor slea, MapleClient c) {
        ...
        farm.setLevel(1);
        c.setFarm(farm);
        c.announce(FarmPacket.updateQuestInfo(1111, 1, "A1/Z/"));
        //c.announce(FarmPacket.updateFarmInfo(c, true));
        //c.announce(CField.getPacketFromHexString("68 03 19 72 1E 02 00 00 00 00 00 00 00 00 00 00 00 00 0A 00 65 73 6D 69 66 61 72 6D 7A 7A 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00 01 00 00 00 00 0B 00 43 72 65 61 74 69 6E 67 2E 2E 2E 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 FF FF FF FF 00"));
        c.announce(FarmPacket.farmPacket4());
        c.announce(FarmPacket.updateQuestInfo(30000, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30003, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30007, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30011, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30015, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30019, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30023, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30027, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30045, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30050, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30055, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30060, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30065, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30070, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30076, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30080, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30081, 0, "A1/"));
        c.announce(FarmPacket.updateQuestInfo(30082, 0, "A1/"));
    }

    public static void completeQuest(LittleEndianAccessor slea, MapleClient c) {
        int questId = slea.readInt();
        if (questId == 1111) {
            c.announce(FarmPacket.updateQuestInfo(1111, 1, ""));
            ...
            c.announce(FarmPacket.updateQuestInfo(1111, 2, timeStr));
            System.out.println(timeStr);
            c.announce(FarmPacket.alertQuest(1111, 0));
            c.announce(FarmPacket.updateQuestInfo(1112, 0, "A1/"));
            c.announce(FarmPacket.updateQuestInfo(1112, 1, "A1/Z/"));
        }
    }
    ...
    public static void renameMonster(LittleEndianAccessor slea, MapleClient c) {
        ...
        c.announce(FarmPacket.renameMonster(monsterIndex, name));
    }
    ...
    public static void firstEntryReward(LittleEndianAccessor slea, MapleClient c) {
        ...
        c.announce(FarmPacket.farmMessage("Find your reward for logging in today \r\nin your inventory."));
    }
