...
public class MapleDataProviderFactory {
    ...
    private final static String wzPath = System.getProperty("path", "") + System.getProperty("wzpath", ServerProperties.getProperty("wzpath", "wz"));
...
//        return getWZ(fileInWZPath(filename.replace(".wz", ".nx")));
